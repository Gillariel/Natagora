...
class MediaFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'Validated' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        'Deleted' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'MediaType_ID' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'MediaType_ID_Dev' => ['type' => 'unique', 'columns' => ['MediaType_ID'], 'length' => []],
            'Observations_ID_Dev' => ['type' => 'unique', 'columns' => ['Observation_ID'], 'length' => []],
            'FK_Media_MediaType' => ['type' => 'foreign', 'columns' => ['MediaType_ID'], 'references' => ['mediatype', 'ID'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'FK_Media_Observations' => ['type' => 'foreign', 'columns' => ['Observation_ID'], 'references' => ['observation', 'ID'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
